...
## Lakeflow Product Family Branding

Databricks data engineering products are branded under the **Lakeflow** family. Prefer current names when writing docs, prompts, or resource descriptions:

- **Lakeflow Spark Declarative Pipelines** (formerly Delta Live Tables / DLT) — declarative ETL pipelines
- **Lakeflow Jobs** (formerly Databricks Jobs / Workflows) — orchestration
- **Lakeflow Connect** — managed ingestion connectors
- **Lakeflow Designer** — no-code/low-code pipeline authoring
...
2. Use this skill to fetch docs if you need clarification on specific Lakeflow Spark Declarative Pipelines features
...
- **databricks-pipelines** - Lakeflow Spark Declarative Pipelines workflows
