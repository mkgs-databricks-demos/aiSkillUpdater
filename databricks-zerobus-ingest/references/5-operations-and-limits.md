...
Use Unity Catalog system tables to monitor Zerobus Ingest activity and streaming output:

```sql
-- Monitor Zerobus Ingest via system tables
SELECT * FROM system.lakeflow.zerobus_ingest
WHERE table_name = 'my_table'
ORDER BY ingest_time DESC;

-- Monitor streaming output
SELECT * FROM system.lakeflow.zerobus_stream
