...
1. **Authenticated Databricks CLI** (>= v1.0.0; current v1.6.0) - see [CLI Authentication Guide](databricks-cli-auth.md) for OAuth2 setup (prefer `databricks auth login`) and profile configuration
