...
LLM_ENDPOINT = "databricks-claude-sonnet-5"   # resolve at runtime — see databricks-model-serving
...
with mlflow.start_run():
    info = mlflow.pyfunc.log_model(
        name="agent",                    # MLflow 3: use name= instead of artifact_path=
...
| Vector Search / AI Search index | `DatabricksVectorSearchIndex(index_name=...)` |
