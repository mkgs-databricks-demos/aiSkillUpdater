...
The most basic pattern with direct column fields and standard aggregations.
...
## Pattern 2: Derived Fields with CASE
...
Pre-compute common aggregations for faster queries. Materialization is in **Preview**.
