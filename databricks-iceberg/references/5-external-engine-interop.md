...
ICEBERG_VER         = "1.9.2"  # minimum for Iceberg v3 support
...
| **v3 table incompatibility** | Upgrade to Iceberg library 1.9.2+ for v3 support; older versions cannot read v3 tables |
