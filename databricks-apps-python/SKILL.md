...
| **Jobs** | Trigger and monitor Lakeflow Jobs from the app (run, poll status, fetch results) |
...
- **[AppKit Docs](https://developers.databricks.com/docs/appkit/v0/)** — getting started, plugins, API reference
- **[AI-assisted development](https://developers.databricks.com/docs/appkit/v0/development/ai-assisted-development)** — guidance for code assistants
- **[llms.txt](https://developers.databricks.com/docs/appkit/v0/llms.txt)** — machine-readable docs for AI context
...
| **Pre-installed** | Dash (verify current in Databricks Apps runtime docs), Streamlit, **Gradio 5.x** (major version bump from 4.x), Flask, FastAPI — **check the current pre-installed versions in the Databricks Apps runtime docs before pinning** |
...
- **[AppKit](https://developers.databricks.com/docs/appkit/v0/)** — preferred SDK for new apps (TypeScript + React)
