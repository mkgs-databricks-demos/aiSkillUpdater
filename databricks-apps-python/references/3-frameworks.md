...
| Detail | Value |
|--------|-------|
| Pre-installed version | verify current version in the Databricks Apps runtime docs (was 2.18.1) |
...
| Detail | Value |
|--------|-------|
| Pre-installed version | Gradio **5.x** (major bump from 4.44.0) — verify current version in the Databricks Apps runtime docs |
| app.yaml command | `["python", "app.py"]` |
