...
- **Serverless SQL warehouse only** — not available on Classic, Pro, or Starter warehouses
- Serverless compute required (DBR 18.2+ environment)
...
- Requires **Serverless SQL warehouse** — "Pro" warehouses run on Classic infrastructure and will not work
