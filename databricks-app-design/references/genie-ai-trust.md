...
> **Verify:** confirm the `useGenieChat` hook signature and the `genie()` plugin scope/space names against the current AppKit v0 docs (`npx @databricks/appkit docs ./docs/plugins/genie.md` and https://developers.databricks.com/docs/appkit/v0/) — these are versioned and may change.
