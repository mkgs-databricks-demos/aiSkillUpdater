...
**AppKit web docs:** The authoritative AppKit documentation is published at **https://developers.databricks.com/docs/appkit/v0/** (the older `databricks.github.io/appkit` location is deprecated). Use the `npx @databricks/appkit docs` CLI for the version installed in your project; use the web docs for browsing/overview.
